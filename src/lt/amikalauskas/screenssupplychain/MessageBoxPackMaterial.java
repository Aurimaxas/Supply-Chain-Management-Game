...
public class MessageBoxPackMaterial extends JFrame {
		JButton OK;
		...
		public MessageBoxPackMaterial(String s) {

			super(s);
		}


		public void MBPackMaterialsScreen() {
			JPanel p = new JPanel();
			p.setLayout(null);
			...
			Notification1.setText("Not enough Pack Materials.");
			...
			Notification2.setText("Pack material stock - "+prestock.getPackagingMaterialPrestock()+" PC, Your Order - "+screenMain.getProductionOrder()+" PC");
